      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="w-full lg:w-1/3">
            <ScrollReveal>
              <h2 className="text-sm font-bold text-gray-900 uppercase mb-8 flex items-center gap-4">
                INDUSTRIES WE SERVE
              ...
              <div className="grid grid-cols-2 gap-y-6 gap-x-4">
                {industries.map((ind, i) => (
                  <div key={i} className="flex flex-col gap-2">
                    <ind.icon size={24} strokeWidth={1.5} className="text-ira-primary-dark" />
              ...
              <div className="grid grid-cols-2 gap-y-6 gap-x-4">
                {features.map((feat, i) => (
                  <div key={i} className="flex items-center gap-2">
                    <feat.icon size={20} strokeWidth={1.5} className="text-ira-accent flex-shrink-0" />
