          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2 sm:gap-4">
            {isLoading ? (
              Array.from({ length: 10 }).map((_, i) => (
                <div key={i} className="bg-white rounded-xl border border-gray-200 p-4 flex flex-col h-full animate-pulse">
                  <div className="bg-gray-200 rounded-lg aspect-video w-full mb-4"></div>
                  ...
                  <div className="bg-gray-200 h-3 w-4/5 rounded mb-4"></div>
                  <div className="bg-gray-200 h-8 w-full rounded mt-auto"></div>
                </div>
              ))
            ) : (
